...
method resize():
    ...
    - re - sizes the image into the final width while maintaining aspect ratio
'''
...
if __name__ == '__main__':
    import os
    import click
    path = os.getcwd() + '/snow.png'
    click.echo(click.style('hello world',fg='bright_blue',bold=True))
    click.echo(click.style(f'{1}test word',fg='black',bold=True))
    runner(path)
